...
import com.cliknfix.technician.customerProfile.PastCustomerProfileFragment;
...
public class PastJobsAdapter extends RecyclerView.Adapter<PastJobsAdapter.viewHolder> {
    ...
    Context context;
    ArrayList<BeanPastJobs> list = new ArrayList<>();

    public PastJobsAdapter(Context context, ArrayList<BeanPastJobs> list) {
